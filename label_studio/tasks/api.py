...
class AnnotationAPI(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        print(os.environ['ENTERPRET_VALIDATE_ENDPOINT'], "TESTING......")
...
class AnnotationsListAPI(generics.ListCreateAPIView):
    ...
    def perform_create(self, ser):
        ...
        if data['isAccepted']:
            ...
            result.append({'value': {'text': [data['message']]}, 'id': '12345', 'from_name': 'Warning', 'to_name': 'Samples', 'type': 'textarea', 'origin': 'prediction'})
            print(result)
